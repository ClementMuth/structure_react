...
export const colors = {
  ...baseColors,
  primaryLighter: lighten(0.2, baseColors.primary),
  primaryLight: lighten(0.4, baseColors.primary),
  secondaryLight: lighten(0.2, baseColors.secondary),
  secondary300: "#8cdcdf",
  lightError: lighten(0.3, baseColors.error),
  lightSuccess: lighten(0.3, baseColors.success),
  lightWarn: lighten(0.25, baseColors.warn)
};
